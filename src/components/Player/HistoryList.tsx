...
export default function HistoryList({
  ...
  return (
    <CollapsibleSection
      sectionKey="history-list"
      title={activeTab === 'history' ? t('index.history') : t('index.favorites')}
      className="bg-white/80 dark:bg-slate-800/50 rounded-2xl shadow-xl backdrop-blur-sm overflow-hidden p-0"
      titleRender={(isExpanded, toggleExpanded) => (
        <div className="w-full relative">
          ...
          <button
            ...
            className="absolute top-3 right-3 p-1.5 rounded-lg bg-slate-100 dark:bg-slate-700/50 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-400 transition-colors"
            aria-expanded={isExpanded}
            aria-controls="collapsible-content-history-list"
          >
